...
export const mapNoteLedgerPosition = {
  'A6': DISTANCE_BETWEEN_STAFF_LINES * -3,
...
export const mapTenutoPosition = {
  'A3': DISTANCE_BETWEEN_STAFF_LINES * 11.5,
  'B3': DISTANCE_BETWEEN_STAFF_LINES * 11.5,
  'C3': DISTANCE_BETWEEN_STAFF_LINES * 10.5,
  'D3': DISTANCE_BETWEEN_STAFF_LINES * 10.5,
  'E3': DISTANCE_BETWEEN_STAFF_LINES * 9.5,
  'F3': DISTANCE_BETWEEN_STAFF_LINES * 9.5,
  'G3': DISTANCE_BETWEEN_STAFF_LINES * 8.5,
  'A4': DISTANCE_BETWEEN_STAFF_LINES * 8.5,
  'B4': DISTANCE_BETWEEN_STAFF_LINES * 7.5,
  'C4': DISTANCE_BETWEEN_STAFF_LINES * 7.5,
  'D4': DISTANCE_BETWEEN_STAFF_LINES * 6.5,
  'E4': DISTANCE_BETWEEN_STAFF_LINES * 6.5,
  'F4': DISTANCE_BETWEEN_STAFF_LINES * 5.5,
  'G4': DISTANCE_BETWEEN_STAFF_LINES * 5.5,
  'A5': DISTANCE_BETWEEN_STAFF_LINES * 4.5,
  'B5': DISTANCE_BETWEEN_STAFF_LINES * 4.5,
  'C5': DISTANCE_BETWEEN_STAFF_LINES * 1.5,
  'D5': DISTANCE_BETWEEN_STAFF_LINES * 0.5,
  'E5': DISTANCE_BETWEEN_STAFF_LINES * 0.5,
  'F5': DISTANCE_BETWEEN_STAFF_LINES * -0.5,
  'G5': DISTANCE_BETWEEN_STAFF_LINES * -0.5,
  'A6': DISTANCE_BETWEEN_STAFF_LINES * -1.5,
  'B6': DISTANCE_BETWEEN_STAFF_LINES * -1.5,
  'C6': DISTANCE_BETWEEN_STAFF_LINES * -2.5,
  'D6': DISTANCE_BETWEEN_STAFF_LINES * -2.5,
  'E6': DISTANCE_BETWEEN_STAFF_LINES * -3.5,
  'F6': DISTANCE_BETWEEN_STAFF_LINES * -3.5,
  'G6': DISTANCE_BETWEEN_STAFF_LINES * -4.5,
  'A7': DISTANCE_BETWEEN_STAFF_LINES * -4.5,
  'B7': DISTANCE_BETWEEN_STAFF_LINES * -5.5,
  'C7': DISTANCE_BETWEEN_STAFF_LINES * -5.5
};
export const mapStaccatoPosition = {
  ...
  'B5': DISTANCE_BETWEEN_STAFF_LINES * 3,
...
export const mapAdjacentDottedPosition = {
  ...mapDottedPosition,
  'A3': DISTANCE_BETWEEN_STAFF_LINES * 7,
  'C3': DISTANCE_BETWEEN_STAFF_LINES * 6,
  'E3': DISTANCE_BETWEEN_STAFF_LINES * 5,
  'G3': DISTANCE_BETWEEN_STAFF_LINES * 4,
  'B4': DISTANCE_BETWEEN_STAFF_LINES * 3,
  'D4': DISTANCE_BETWEEN_STAFF_LINES * 2,
  'F4': DISTANCE_BETWEEN_STAFF_LINES * 1,
  'A5': DISTANCE_BETWEEN_STAFF_LINES * 0,
  'C5': DISTANCE_BETWEEN_STAFF_LINES * -1
};
export const mapAdjacentFlippedDottedPosition = {
  ...mapDottedPosition,
  'B5': DISTANCE_BETWEEN_STAFF_LINES * 1,
  'D5': DISTANCE_BETWEEN_STAFF_LINES * 0,
  'F5': DISTANCE_BETWEEN_STAFF_LINES * -1,
  'A6': DISTANCE_BETWEEN_STAFF_LINES * -2,
  'C6': DISTANCE_BETWEEN_STAFF_LINES * -3,
  'E6': DISTANCE_BETWEEN_STAFF_LINES * -4,
  'G6': DISTANCE_BETWEEN_STAFF_LINES * -5,
  'B7': DISTANCE_BETWEEN_STAFF_LINES * -6
};
export const mapStaffLines = {
  'A3': {
    showBottomLedgerFive: true,
    showBottomLedgerFour: true,
    showBottomLedgerThree: true,
    showBottomLedgerTwo: true,
    showBottomLedgerOne: true
  },
  'B3': {
    showBottomLedgerFive: true,
    showBottomLedgerFour: true,
  ...
  'G5': {},
  'A6': {
    showTopLedgerOne: true
  },
  'B6': {
    showTopLedgerOne: true
  },
  'C6': {
    showTopLedgerTwo: true,
    showTopLedgerOne: true
  },
  'D6': {
    showTopLedgerTwo: true,
