...
export const PedalStartSVG = ({ transform }) => {
  return (
    <g data-testid="subcomponent-pedal-start" transform={transform} aria-label="pedal start" >
      <g transform="matrix(0.98982022,0,0,1,-91.97415,79.212368)" >
...
export const PedalEndSVG = ({ transform }) => {
  return (
    <g data-testid="subcomponent-pedal-end" transform={transform} aria-label="pedal end" >
      <g transform="matrix(-0.98982021,0,0,1,249.40124,79.212328)" >
