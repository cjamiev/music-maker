...
export const FermataSVG = ({ transform, conditions = {} }) => {
  const { showFlipped } = conditions;
  const matrix = showFlipped ? 'matrix(0.54569976,0,0,-0.54569976,-20.96507,223.12753)' : 'matrix(0.54569976,0,0,0.54569976,-20.96507,1.372411)';
...
export const StemmedNoteSVG = ({ transform, conditions = {} }) => {
  const { showNoteStem = true, showEighthNote, showHalfNote, showSixteenthNote } = conditions;
  ...
  return (
    <g data-testid="subcomponent-stemmed-note" transform={transform} aria-label="stemmed note" >
      ...
      { (showEighthNote || showSixteenthNote) && <path data-testid="eighth-note-flag" className="svg__31" aria-label="condition eighth note flag" d="m 82.49591,94.62796 c 0,0 -0.30133,3.29712 2.86944,4.79505 3.17077,1.49795 0.69676,9.39918 0.63805,9.28395 -0.0588,-0.11522 1.85547,-6.80885 -1.01972,-8.09327 -2.77486,-1.2396 -2.56154,-1.08227 -2.56154,-1.08227 l 0.0738,-4.90346" /> }
...
export const StemmedNoteFlippedSVG = ({ transform, conditions = {} }) => {
  ...
  return (
    <g data-testid="subcomponent-stemmed-note-flipped" transform={transform} aria-label="stemmed note flipped" >
      ...
      { showNoteStem && <rect data-testid="note-stem" className="svg__20" aria-label="condition note stem flipped" width="0.45734397" height="16.595196" x="74.956619" y="113.24069" /> }
      { (showEighthNote || showSixteenthNote) && <path data-testid="eighth-note-flag" className="svg__31" aria-label="condition eighth note flag flipped" d="m 75.40634,129.83554 c 0,0 -0.30133,-3.29712 2.86944,-4.79505 3.17077,-1.49795 0.69676,-9.39918 0.63805,-9.28395 -0.0588,0.11522 1.85547,6.80885 -1.01972,8.09327 -2.77486,1.2396 -2.56154,1.08227 -2.56154,1.08227 l 0.0738,4.90346" /> }
