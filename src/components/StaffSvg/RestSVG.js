...
export const RestSVG = ({ transform, conditions = {} }) => {
  const { showWholeRest, showHalfRest, showQuarterRest, showSixteenthRest } = conditions;
  ...
  return (
    <g data-testid="component-rest" aria-label="rest" transform={transform} >
      ...
      <g data-testid="coondition-eight-rest" aria-label="coondition eight rest" transform="matrix(0.30883171,0,0,0.30883171,17.852318,95.685104)" >
