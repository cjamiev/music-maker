...
export const DynamicsSVG = ({ transform, conditions = {}, content = {} }) => {
  const { showCrescendo, showDecrescendo } = conditions;
  ...
  return (
    <g data-testid="component-dynamics" aria-label="dynamics" transform={transform} >
      ...
      { content.value &&
        <text data-testid="dynamic-text" className="svg__16" aria-label="condition dynamic text" x="88.241692" y="126.39545" transform="scale(0.87702874,1.1402135)" >
          <tspan data-testid="tspan1893" className="svg__17" x="88.241692" y="126.39545" >{content.value}</tspan>
        </text>
      }
    </g>
  );
